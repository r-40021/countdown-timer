...
function resize() {
  ...
  if (window.innerWidth <= 775) {
    document.getElementById("timerSet").style.fontSize = "min(" + 150 / count + "vmin ,250px)"; //文字サイズ調整(Tablet&SP)  

  } else {
    document.getElementById("timerSet").style.fontSize = "min(" + 185 / count + "vmin ,250px)"; //文字サイズ調整
  }
}
